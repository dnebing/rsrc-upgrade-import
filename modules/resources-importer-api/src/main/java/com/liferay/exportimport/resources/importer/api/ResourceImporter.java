...
public class ResourceImporter extends FileSystemImporter {
	...
	public ResourceImporter(
			...
			DLFolderLocalService dlFolderLocalService, GroupLocalService groupLocalService,
		...
		super(
			...
			dlFileEntryLocalService, dlFolderLocalService, groupLocalService, indexStatusManager,
			...
			repositoryLocalService, saxReader, themeLocalService, userLocalService);
	}
